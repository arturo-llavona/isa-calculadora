...
public class CalculadoraTest {
	...
	public void testSuma() {
		...
		// Comprobamos la suma de un número positivo con otro negativo cuyo resultado es
		// positivo
	...
	public void testResta() {
		...
		// Comprobamos la resta de un número positivo con otro negativo cuyo resultado
		// es positivo
	...
	public void testDivision() {
		...
		// Comprobamos la división con decimales, de un número positivo con otro
		// negativo
		assertEquals(new Double(-2.5), Calculadora.divide(5, -2));
	...
	public void testRaizCuadrada() {
		...
		// Comprobamos la raiz cuadrada que da de resultado un decimal. Como la
		// precisión debe ser mayor a 10-5 supongo 6 decimales.
		assertEquals(new Double(2.236068), Calculadora.raizCuadrada(5));

		// Comprobamos que la raiz cuadrada de un número negativo no se intenta calcular
		// y devuelve null
